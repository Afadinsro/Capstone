...
public class UploadMediaService extends JobService {
    ...
    public boolean onStartJob(final JobParameters job) {
        ...
        imageTask = new UploadImageTask(job){
            @Override
        ...
        return moreWork; // Is there still more work to do?
    }
    ...
    public static class UploadImageTask extends AsyncTask<Void, Void, Boolean>{
        ...
        UploadImageTask(JobParameters jobParameters) {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            if(jobParameters.getExtras() != null){
                key = jobParameters.getExtras().getString(PUSHED_REPORT_KEY);
                Log.d(TAG, "doInBackground: Push key: " + key);
                String path = jobParameters.getExtras().getString(IMAGE_FILE_ABS_PATH);
                mediaFile = (path != null) ? new File(path) : null;
                Log.d(TAG, "doInBackground: Media file path: " + mediaFile);
            }
            Log.d(TAG, "doInBackground:AsyncTask started.");
            uploadImage();
            return retry;
        }
